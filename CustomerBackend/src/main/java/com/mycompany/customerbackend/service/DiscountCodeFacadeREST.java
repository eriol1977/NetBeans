...
import com.mycompany.customerbackend.DiscountCode;
 ...
 */
@Stateless
@Path("com.mycompany.customerbackend.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {
    @PersistenceContext(unitName = "com.mycompany_CustomerBackend_war_1.0-SNAPSHOTPU")
