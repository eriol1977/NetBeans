...
import com.mycompany.peoplebackend.People;
...
public class PeopleFacadeREST extends AbstractFacade<People> {
    @PersistenceContext(unitName = "com.mycompany_PeopleBackend_war_1.0-SNAPSHOTPU")
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Long id, People entity) {
        super.edit(entity);
    }
    ...
    public People find(@PathParam("id") Long id) {
